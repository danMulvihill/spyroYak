...
<div class="image"><img src="http://spyroyak.com/img/WritingSystemsoftheWorld.png"><br>
...
<h1>Display a Unicode (or ASCII) Chart</h1>
	...
	<fieldset>
		...
		<button onclick="openSec('cjk')">CJK Ideographs</button>
               <button onclick="displayChars(0x0020,0x2e7f)">1st 11,903 characters</button>
                <button onclick="displayChars(0x2e80,0xFFFF)">Everything Else</button>
	</fieldset>
