...
<h1>Display a Unicode (or ASCII) Chart</h1>
	...
	<div id="buttons">
		...
		<h3 onclick="openSec('west')">Latin Alphabet</h3>
		<ul>
		    <li><button onclick="displayChars(32,127)">7-bit ASCII</button>
			<li><button onclick="displayChars(0x0080,0x00FF)">8-bit ASCII Supplement</button>
			<li><button onclick="displayChars(0x0100,0x017F)">Latin Extended-A </button>
            <li><button onclick="displayChars(0x0180,0x024F)">Latin Extended-B</button>
			<li><button onclick="displayChars(0x0250,0x036F)">International Phonetic Alphabet</button>
		</ul>
	</div>
